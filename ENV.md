...
One `-arch=sm_89` build serves both targets.
...
- GPU partition: `ice-gpu`, `--gres=gpu:l40s:N` - 8x L40S (48 GB, Ada `sm_89`), sockets S:0-3.
...
- `nvidia-smi topo -m` (2x L40S, ice-gpu, node atl1-1-03-004-21): GPU0<->GPU1 = **PXB**
