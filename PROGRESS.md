...
| 9 | GRPO loop | done | ✓ advantages vs formula; GRPO bwd == CE bwd (bit-exact) + linearity | SFT 0→~90% then GRPO refines →100%; rollouts 51k tok/s prefix-shared | cold-start RL collapses (needs pretrained policy) |
